...
from dataLoader import loadDataCifar10_DANN
            ...
            for i in range(num_batches):
                ...
                if epoch < args.start_epoch:
                    ...
                    _, acc, loss = sess.run([model.first_train_op, model.accuracy, model.loss],
                                            ...
                                            model.lamb: args.lam})
                if args.adv_flag:
                    _, adv_loss, a1, a2, b1, b2 = sess.run([model.second_train_op, model.adv_loss, model.y_adv_loss, model.y_adv_loss_2, model.conv3, model.conv3_2],
                                           feed_dict={x: batch_x, 
                                           x2: batch_x2, 
                                           y: batch_y, 
                                           model.keep_prob: 0.5, 
