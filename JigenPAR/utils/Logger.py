...
class Logger():
    ...
    def get_name_from_args(args):
        ...
        name = "eps%d_bs%d_lr%g_class%d_parWeight%g" % (args.epochs, args.batch_size, args.learning_rate, args.n_classes,
                                                                   args.par_weight)
        ...
        try:
            name += "_entropy%g_par_tW%g" % (args.entropy_weight, args.target_weight)
